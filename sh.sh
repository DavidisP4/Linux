...
for i in $(seq 1 $NUM_PRS); do
  ...
  git add README.md
  git commit -m "chore: guy is king $i to README"
...
echo "-------------------------"
echo "Now merging all PRs from 4 to 99..."

# Loop through PR numbers from 4 to 99
for PR_NUMBER in $(seq 1 $NUM_PRS); do
  echo "Merging PR #$PR_NUMBER..."
  
  # Attempt to merge using a merge commit
